...
export const AddNewBook = () => {
    ...
    async function base64ConversonFormages(e:any) {
        if(e.target.files[0]){
    ...
    async function submitNeweBook() {
        const url = `http://localhost:8080/api/admin/secure/add/book`;
        if(authState?.isAuthenticated && title !== '' && author !== '' && category !== ''
            ...
            const requestOptions = {
             ...
             if(!submitNewBookResponse.ok){
                throw new Error('something went wrong while submitting new book');
             }
             setTitle('');
             setAuthor('');
             setDescription('');
            ...
            <div className='card'>
                ...
                <div className='card-body'>
                    <form method='POST'>
                        ...
                        <input type='file' onChange={e => base64ConversonFormages(e)}/>
                        <div>
                            <button type='button' className='btn btn-primary mt-3'
                            onClick={submitNeweBook}>
                                Add Book
                            </button>
                        </div>
                    </form>
